...
public class MintButton : MonoBehaviour
{
    ...
    {
        script.ThrowAConfirmScreen("Вы уверены? Это может занять какое-то время", () => {
            ...
            if (File.Exists(Application.persistentDataPath + fileName))
            {
                Mint_File
                    ...
                    .SetParameters(
                        ...
                        Description: descField.text != "" ? descField.text : fileName,
            ...
            {
                script.ThrowAnError("Файл с рисунком не был найден. Возможно вы выбрали не тот номер рисунка.");
            }
        });
    }
}
